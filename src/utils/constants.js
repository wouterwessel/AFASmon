...
export const TYPE_CHART = {
  ...
  DOEN:       { DOEN: 1.0, VERTROUWEN: 1.5, GEK: 0.75, FAMILIE: 0.75, LEGENDARY: 1.0 },
  VERTROUWEN: { DOEN: 0.75, VERTROUWEN: 1.0, GEK: 1.5, FAMILIE: 0.75, LEGENDARY: 1.0 },
  GEK:        { DOEN: 0.75, VERTROUWEN: 0.75, GEK: 1.0, FAMILIE: 1.5, LEGENDARY: 1.0 },
  FAMILIE:    { DOEN: 1.5, VERTROUWEN: 0.75, GEK: 0.75, FAMILIE: 1.0, LEGENDARY: 1.0 },
  LEGENDARY:  { DOEN: 1.0, VERTROUWEN: 1.0, GEK: 1.0, FAMILIE: 1.0, LEGENDARY: 1.0 },
};
